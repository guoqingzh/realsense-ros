...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'tm2_enable_mapping',           'default': 'false', 'description': 'tm2 options'},
                           {'name': 'tm2_enable_reloc',             'default': 'false', 'description': 'tm2 options'},
                           {'name': 'tm2_enable_jump_pose',         'default': 'false', 'description': 'tm2 options'},
                           {'name': 'tm2_enable_preservation',  'default': 'false', 'description': 'tm2 optinos'},
